        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillId1 = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSkills_Skils_SkillId1",
                        column: x => x.SkillId1,
                        principalTable: "Skils",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSkills_Users_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectsComments_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectsComments_ProjectId",
